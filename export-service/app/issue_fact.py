...
DEFAULT_SUMMARY_EXCLUSION_CLAUSE = '(summary !~ "MAIN2MP" AND summary !~ "MP2SMR" AND summary !~ "CloneMP")'
DEFAULT_RESOLUTION_EXCLUSION_CLAUSE = '(resolution is EMPTY OR resolution not in ("Needn\'t Fixed", "Duplicate", "Duplicated"))'
DEFAULT_FETCH_FILTER_CLAUSE = (
    f"{DEFAULT_ISSUE_TYPE_CLAUSE} AND {DEFAULT_STATUS_CLAUSE} AND "
    f"{DEFAULT_SUMMARY_EXCLUSION_CLAUSE} AND {DEFAULT_RESOLUTION_EXCLUSION_CLAUSE}"
)
